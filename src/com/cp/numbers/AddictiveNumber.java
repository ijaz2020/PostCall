...
public class AddictiveNumber {
    public static void main(String[] args){
        AddictiveNumber a = new AddictiveNumber();
        System.out.println(a.isAdditiveNumber("199100199", a));
    }
    public boolean isAdditiveNumber(String num, AddictiveNumber a) {
        int L = num.length();
        ...
        for(int i=1; i<=(L-1)/2; i++) {
            ...
            for(int j=i+1; L-j>=j-i && L-j>=i; j++) {
                ...
                if(a.isAdditive(substr, num1, num2)) return true; // return true if passes isAdditive test
